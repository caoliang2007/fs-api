...
JAVA_OPTS="-Dfile.encoding=UTF-8 -Dsun.jnu.encoding=UTF-8  -Xmn256m -Xmx1g -Xms1g -XX:+UseG1GC"
RUN_ARGS="--spring.config.location=file:../conf/,classpath:/application.properties"
...
do_start() {
  RUN_ARGS="$RUN_ARGS  --spring.profiles.active=prod"
